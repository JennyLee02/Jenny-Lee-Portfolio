    ...
    mx-auto">
      ...
      top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        <div className="flex flex-col justify-center items-center mt-5">
          {/* use self-closing div tag to create objects */}
        ...
        <div>
          ...
          className="text-[#915eff]">Jenny</span>
          </h1>
          <p className={`${styles.heroSubText}mt-2 text-white-100`}>
            I am a Computer Engineering student at <br className="hidden sm:block"/> 
             the University of Waterloo,
            passionate about innovating <br/> 
             in the realms of web and game development 
          </p>
        </div>
      </div>
      <ComputersCanvas/>
